...
import TalkieMovieStack from "./TalkieMovieStack";
import TalkieVideoGameStack from "./TalkieVideoGameStack";
...
const WeelStack = (props) => {
  ...
  return (
    <Stack.Navigator screenOptions={{ headerShown: false }}>
      ...
      <Stack.Screen
        component={MyActivitiesMeeting}
        name="MyActivitiesMeeting"
      />
      ...
      {/* <Stack.Screen component = {ShopEatStack} name="ShopEat" /> */}
      <Stack.Screen
        component={shopEntertainmentStack}
        name="ShopIntertenment"
      />
      {/* <Stack.Screen component = {ShopProductStack} name="ShopProduct" /> */}
